...
function Player:ItemSort_GetContainerSize(nContainerId)
	local tbFixedContainerTable = { Item.ROOM_MAINBAG, Item.ROOM_REPOSITORY, Item.ROOM_EXTREP1,Item.ROOM_EXTREP2,Item.ROOM_EXTREP3,Item.ROOM_EXTREP4,Item.ROOM_EXTREP5 }; --, Item.ROOM_EXTREP1, Item.ROOM_EXTREP2, Item.ROOM_EXTREP3, Item.ROOM_EXTREP4, Item.ROOM_EXTREP5 };
	local tbExtBag = {  Item.ROOM_EXTBAG1,  Item.ROOM_EXTBAG2,Item.ROOM_EXTREP3, Item.ROOM_EXTREP4,Item.ROOM_EXTREP5 };
